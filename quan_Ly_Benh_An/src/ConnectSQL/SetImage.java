...
public class SetImage {
    ...
    public static Image resize( Image orginalImage, int chieuRong, int chieuDai){
        Image resultingImage = orginalImage.getScaledInstance(chieuRong, chieuDai, Image.SCALE_SMOOTH);
